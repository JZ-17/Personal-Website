export const project = [
    ...
    },
    {
      ...
      award: null,
      accomplishment:
        "Implemented a new interactive chatbot feature Cupid with OpenAI's Assistant API with a custom-made front-end interface and redesigned the Datamatch website's home page layout, enhancing the experience for over 20K users seeking love on Valentine's Day",
      actions: [
